      ...
      body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                Image.asset(
                  "assets/images/TripFuelCostEstimator.png",
                  scale: 4,
                ),
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          errorText: validateData(distanceController.text)
                              ? null
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          errorText: validateData(fuelEfficiencyController.text)
                              ? null
                ...
                SizedBox(height: 20),
                Text("Total Fuel Cost: RM ${totalCost.toStringAsFixed(2)}"),
                SizedBox(height: 30),
                ElevatedButton(
                  onPressed: calculateCost,
                  child: Text('Calculate Fuel Cost',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
          ),
