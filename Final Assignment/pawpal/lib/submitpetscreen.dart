...
class _SubmitPetScreenState extends State<SubmitPetScreen> {
  ...
  List<String> types = ['Dog', 'Cat', 'Rabbit', 'Other'];
  List<String> genders = ['Male', 'Female'];
  List<String> healthStatus = ['Healthy', 'Unhealthy'];
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Select Health Status',
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10.0),
                    ),
                  ),
                  items: healthStatus.map((health) {
                    return DropdownMenuItem(value: health, child: Text(health));
                  }).toList(),
                  onChanged: (String? newValue) {
